...
public class PhotoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view.nameView.setName(owner.name);
        view.nameView.setHandle(owner.handle);
        
        view.infoView.setVisbility(photo.isPublic);
        view.infoView.setTime(photo.time);
        view.infoView.setPlace(photo.place);

        view.statsView.setLikes(photo.likes);
        view.statsView.setComments(photo.comments);
